 ...
 * @data 2017年2月13日
 */
public class ChanelDLZMViewHolder extends BaseViewHolder {

	@ViewInject(R.id.inCon_channel_dlzm_running_no)
	private InputComponent incomRunningNo; // 运行编号

	@ViewInject(R.id.inCon_channel_dlzm__operation_ywdw)
