...
* Excel电缆分支箱4.0实体
*/
public class ExcelEntity4Dlfzx {
	...
	@CellColum(headerName = "类型", index = 10)
	private String lx; // 类型

	@CellColum(headerName = "型号", index = 11)
	...
	@CellColum(headerName = "出厂日期", index = 14)
	private Date ccrq; // 出厂日期

	@CellColum(headerName = "投运日期", index = 15)
	private Date tyrq; // 投运日期

	@CellColum(headerName = "接地电阻", index = 16)
	...
	@CellColum(headerName = "是否代维", index = 23)
	private String sfdw;
	@CellColum(headerName = "是否农网", index = 24)
	private String sfnw;
