package com.winway.android.edcollection.login.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context,
					R.layout.activity_projecting_lv_item, null);
			holder = new ViewHolder();
			holder.text = (TextView) convertView
					.findViewById(R.id.tv_pro_lv_item_projectName);
			holder.img = (ImageView) convertView
					.findViewById(R.id.iv_pro_lv_item_confirm);
