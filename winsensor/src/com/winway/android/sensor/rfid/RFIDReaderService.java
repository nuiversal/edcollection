...
public class RFIDReaderService {
	...
	// public static final int RTK_MESSAGE_READ = 20;
	...
	/**
	 * Constructor. Prepares a new BluetoothReader session.
	 * 
	 * @param context
	...
	private class AcceptThread extends Thread {
		...
		public void run() {
			...
			while (mState != STATE_CONNECTED) {
				...
				if (socket != null) {
					synchronized (RFIDReaderService.this) {
						switch (mState) {
						case STATE_LISTEN:
