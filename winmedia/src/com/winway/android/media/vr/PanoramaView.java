...
public class PanoramaView extends GLSurfaceView {
	...
	private PanoramaView(Context context) {
		super(context);
		init(null, context);
	}
	 ...
	 */
	public PanoramaView(Context context, int drawableId) {
		super(context);
	 ...
	 * @param bitmap   全景图片
	 */
	public PanoramaView(Context context, Bitmap bitmap) {
		super(context);
		setEGLContextClientVersion(2);
	 ...
	 */
	public PanoramaView(Context context, String imageFilePath) {
		super(context);
		setEGLContextClientVersion(2);
