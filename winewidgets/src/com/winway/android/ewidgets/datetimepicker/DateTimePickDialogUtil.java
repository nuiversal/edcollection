package com.winway.android.ewidgets.datetimepicker;
...
public class DateTimePickDialogUtil implements OnDateChangedListener, OnTimeChangedListener {
	...
	public AlertDialog dateTimePicKDialog(final EditText inputDate) {
		ScrollView dateTimeLayout = (ScrollView) activity.getLayoutInflater().inflate(R.layout.common_datetime, null);
		...
		ad = new AlertDialog.Builder(activity).setTitle(initDateTime).setView(dateTimeLayout)
				.setPositiveButton("设置", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int whichButton) {
						inputDate.setText(inputDate.getText().toString());
					}
				}).show();
