 ...
 * 
 */
public class CopyOfKtableView extends ScrollView {
	...
	public CopyOfKtableView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setTableHeaders(String[] header) {
		...
		AddContentsRow addContentsRow = new AddContentsRow(getContext(), header);
		if (resId != 0) {
			addContentsRow.setBackground(resId);
		} else {
			addContentsRow.setBackColor(backgroudColor);
		}
		addContentsRow.setTextColor(Color.BLACK);
