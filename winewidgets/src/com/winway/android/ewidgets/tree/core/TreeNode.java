...
public class TreeNode {
	...
	public static abstract class BaseNodeViewHolder<E> {
		...
		public View getNodeView() {
			View view = createNodeView(mNode, (E) mNode.getValue());
	...
	/**
	 * 修改:加上一个URL数据加载器，点击节点的时候会调用加载器加载数据
	 * @author mr-lao
	 * @date 2016-12-16
	 */
	private DefaultTreeNodeHolder2.URLNodeLoader urlNodeLoader;

	public DefaultTreeNodeHolder2.URLNodeLoader getUrlNodeLoader() {
		return urlNodeLoader;
	}

	public void setUrlNodeLoader(DefaultTreeNodeHolder2.URLNodeLoader urlNodeLoader) {
		this.urlNodeLoader = urlNodeLoader;
	}
